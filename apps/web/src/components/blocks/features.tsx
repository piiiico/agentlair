...
const items = [
  ...
  },
  {
    ...
    description:
      "Log every tool call, LLM invocation, and decision to a persistent, queryable audit trail. EdDSA-signed entries — tamper-evident by construction. Designed for EU AI Act Article 12 compliance.",
    icon: ScrollText,
