...
- [AAT × APS boundary](/docs/aps-boundary) — `al_nid` is one of three claims that bridge AAT session identity to APS post-handoff receipts (the same Ed25519 key signs both). Jointly maintained with AEOESS.
