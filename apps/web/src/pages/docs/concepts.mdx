...
description: "What is an AAT? What is L4 behavioral trust? How does JWKS verification work? AgentLair vs static identity."
---
...
- [AgentLair L4 Spec](https://agentlair.dev/spec) — full protocol specification
